...
/*	Holly McCrea */
/*added code to check if it is a column visibility button and toggle the icon */			
				if ( button.hasClass('ui-button-text-only') ){
					if (button.hasClass('ui-state-active') ){
						
						$(this).find('i').removeClass('fa-check-square');
						$(this).find('i').addClass('fa-square');
						
					} else if (button.hasClass('ui-state-default')){
